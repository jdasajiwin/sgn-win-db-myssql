...
START TRANSACTION;
-- m_eventos
INSERT  INTO m_eventos (cod_evento,desc_evento,tipo_evento,desc_usuario_crea,desc_usuario_modf,fec_creacion,fec_modf,id_estado) 
VALUES
('USER_REG','CREAR USUARIO','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('USER_EDIT','EDITAR USUARIO','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('USER_DEL','ELIMINAR USUARIO','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('USER_EXPORT','EXPORTAR USUARIO','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('RN_REG','CREAR RANGO DE NUMERACIÓN','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('RN_CAMBIAR_EST','CAMBIAR ESTADO RANGO DE NUMERACIÓN','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('RN_EXPORT','EXPORTAR RANGO DE NUMERACIÓN','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('NUM_TEL_EDIT','EDITAR NUMERO TELEFÓNICO','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('NUM_TEL_EXPORT','EXPORTAR NUMERO TELEFÓNICO','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('PORT_IMPORT','IMPORTAR PORTABILIDAD','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('PORT_EDIT','EDITAR PORTABILIDAD','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('PORT_EXPORT','EXPORTAR PORTABILIDAD','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('NUM_WINET','ACTIVACIÓN','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('NUM_PORTA','ACTIVACIÓN','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('DIA_RES_BAJA_REG','CREAR DÍAS DE RESERVA DE BAJA','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('DIA_RES_BAJA_EDIT','EDITAR DÍAS DE RESERVA DE BAJA','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('DIA_RES_BAJA_DEL','ELIMINAR DÍAS DE RESERVA DE BAJA','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('DIA_PRE_RESER_REG','CREAR DÍAS DE PRE-RESERVA','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('DIA_PRE_RESER_EDIT','EDITAR DÍAS DE PRE-RESERVA','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('DIA_PRE_RESER_DEL','ELIMINAR DÍAS DE PRE-RESERVA','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('CANT_NUM_REG','CREAR CANTIDAD MÍNIMA DE NÚMEROS A GENERAR','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('CANT_NUM_EDIT','EDITAR CANTIDAD MÍNIMA DE NÚMEROS A GENERAR','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('CANT_NUM_DEL','ELIMINAR CANTIDAD MÍNIMA DE NÚMEROS A GENERAR','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('PROV_NUM_REG','CREAR PROVEEDOR DE NUMERACIÓN','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('PROV_NUM_EDIT','EDITAR PROVEEDOR DE NUMERACIÓN','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('PROV_NUM_DEL','ELIMINAR PROVEEDOR DE NUMERACIÓN','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('COMER_REG','CREAR COMERCIALIZADOR','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('COMER_EDIT','EDITAR COMERCIALIZADOR','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('COMER_DEL','ELIMINAR COMERCIALIZADOR','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('OPERA_REG','CREAR OPERADORES','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('OPERA_EDIT','EDITAR OPERADORES','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('OPERA_DEL','ELIMINAR OPERADORES','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('MOT_CAMB_REG','CREAR MOTIVO DEL CAMBIO DE ESTADO','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('MOT_CAMB_EDIT','EDITAR MOTIVO DEL CAMBIO DE ESTADO','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('MOT_CAMB_DEL','ELIMINAR MOTIVO DEL CAMBIO DE ESTADO','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('PL_TEL_REG','CREAR PLANES DE TELEFONÍA','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('PL_TEL_EDIT','EDITAR PLANES DE TELEFONÍA','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('PL_TEL_DEL','ELIMINAR PLANES DE TELEFONÍA','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('DEPART_REG','CREAR DEPARTAMENTOS','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('DEPART_EDIT','EDITAR DEPARTAMENTOS','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('DEPART_DEL','ELIMINAR DEPARTAMENTOS','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('EST_NUM_TEL_REG','CREAR ESTADOS DEL NÚMERO TELEFÓNICO','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('EST_NUM_TEL_EDIT','EDITAR ESTADOS DEL NÚMERO TELEFÓNICO','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('EST_NUM_TEL_DEL','ELIMINAR ESTADOS DEL NÚMERO TELEFÓNICO','FORMULARIO','ADMIN','ADMIN',NOW(),NOW(),1),
('API_OBT_NUM','OBTENER NÚMERO','API','ADMIN','ADMIN',NOW(),NOW(),1),
('API_REG_NUM_PORTIN','REGISTRAR NÚMERO PORT IN','API','ADMIN','ADMIN',NOW(),NOW(),1),
('API_ACT_NUM_FREESW','ACTIVACIÓN DE NÚMERO TELEFÓNICO EN FREESWITCH','API','ADMIN','ADMIN',NOW(),NOW(),1),
('API_NUM_NCE','GESTIÓN DEL NÚMERO TELEFÓNICO EN NCE','API','ADMIN','ADMIN',NOW(),NOW(),1),
('API_LIB_NUM_BL','LIBERAR NÚMERO BLOQUEADO','API','ADMIN','ADMIN',NOW(),NOW(),1),
('API_CONS_NUM','CONSULTA DE NÚMERO ','API','ADMIN','ADMIN',NOW(),NOW(),1),
('API_CAM_NUM','CAMBIO DE NÚMERO TELEFÓNICO','API','ADMIN','ADMIN',NOW(),NOW(),1),
('API_CAM_NUM_PORT','CAMBIO DE NÚMERO POR PORTABILIDAD','API','ADMIN','ADMIN',NOW(),NOW(),1),
('API_BAJA_NUM','BAJA DE NÚMERO TELEFÓNICO','API','ADMIN','ADMIN',NOW(),NOW(),1),
('API_CB_TITU','CAMBIO DE TITULARIDAD DE NÚMERO TELEFONICO ','API','ADMIN','ADMIN',NOW(),NOW(),1),
('API_PORTIN_DEL','ELIMINAR NÚMERO BLOQUEADO PORT IN','API','ADMIN','ADMIN',NOW(),NOW(),1),
('API_NOT_PORTOUT','PORT OUT CON NOTIFICACIÓN A LAS VNOs','API','ADMIN','ADMIN',NOW(),NOW(),1),
('API_NOT_STOCK','Noticación de stock mínimo de numeración','API','ADMIN','ADMIN',NOW(),NOW(),1),
('API_ALERT_BAJA_FREESW','Alerta de baja pendiente en FreeSwitch','API','ADMIN','ADMIN',NOW(),NOW(),1),
('JOB_LIB_AUTO','LIBERACIÓN AUTOMÁTICA DE NÚMEROS BLOQUEADOS','JOB','ADMIN','ADMIN',NOW(),NOW(),1),
('JOB_PORTA','Proceso automático de portabilidad','JOB','ADMIN','ADMIN',NOW(),NOW(),1);
